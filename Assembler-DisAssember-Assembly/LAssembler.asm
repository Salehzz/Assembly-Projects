...
section .data
  ...
  opcodeszerov	dq	"stc","clc","std","cld","syscall","ret","leave",0
  opcodeszero	dq	"f9","f8","fd","fc","0f05","c3","c9",0
  
  
  outputname	db	"610396109_asm.txt",0
  inputname	db	"input_asm.txt",0
  codeindex	dq	0
  hexcodeindex	dq	0
  outputindex	dq	0
  inputindex	dq	0
